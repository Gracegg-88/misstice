...
const destinations = [
  ...
  },
  {
    ...
    className: "border border-plum/15 bg-white text-plum",
  },
];
  ...
  return (
    <section aria-labelledby="orienter-title" className="bg-cream px-4 py-14 sm:px-8 lg:py-20">
      <div className="mx-auto max-w-content">
        <div className="grid items-end gap-5 border-b border-plum/15 pb-8 lg:grid-cols-[1.15fr_.65fr]">
          <div>
            <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.15em] text-festif">Un point de départ, pas un tunnel</p>
        ...
        <div className="mt-7 grid gap-3 lg:grid-cols-3">
          {destinations.map((destination, index) => (
            ...
            >
              <span className="text-[11px] font-bold uppercase tracking-[0.14em] opacity-70">0{index + 1} · {destination.eyebrow}</span>
              <h3 className="mt-auto max-w-[14ch] font-display text-3xl font-semibold leading-none tracking-tight">{destination.title}</h3>
              <p className="mt-3 max-w-sm text-sm leading-relaxed opacity-75">{destination.body}</p>
        ...
        <div className="mt-7 grid gap-4 border-t border-plum/15 pt-7 md:grid-cols-3">
